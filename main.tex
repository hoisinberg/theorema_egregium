...
\begin{align*}
\partial_i \hat{n} = (\partial_i \vec{N})_{\perp \hat{n}} = \alpha (\partial_1 \vec{r}) + \beta (\partial_2 \vec{r})
\end{align*}
...
{
\newcommand{\ndrone}{(\partial_i \vec{N})_{\perp \hat{n}} \cdot \partial_1{\vec{r}}}
\newcommand{\ndrtwo}{(\partial_i \vec{N})_{\perp \hat{n}} \cdot \partial_2{\vec{r}}}
...
\section{The First Fundamental Form, I}

In the standard literature, the quantities $E$, $F$, and $G$ in the preceding section are grouped into the following matrix called the \textbf{first fundamental form}, whose determinant appears in the denominators of Eq. \eqref{eq6} and Eq. \eqref{eq7}.
...
&= \alpha_1 \alpha_2 E + (\alpha_1 \beta_2 + \beta_1 \alpha_2) F + \beta_1 \beta_2 G \\
&=
...
That is, the first fundamental form allows us to compute the physical-space ($\mathbb{R}^3$) dot product of the coordinate velocity vectors $\vec{v}_1, \vec{v}_2 \in T_{\vec{r}}S$ in terms of their respective coordinate-space representations $(\alpha_1, \beta_1), (\alpha_2, \beta_2) \in \mathbb{R}^2$. I therefore captures critical information about the coordinate-space-to-physical-space mapping defined by $\vec{r}$.
